...
# t test ZA NEZAVISNE UZORKE (Student) 
<html><div style='float:left'></div><hr color='#EB811B' size=1px width=796px></html>
(Realnija varijanta...za nezavisne uzorke)
---
...
<html><div style='float:left'></div><hr color='#EB811B' size=1px width=796px></html>
(Realnija varijanta...za zavisne uzorke)
---
...
knitr::kable(tibble::tribble(
  ...
  ), col.names = c(  "$d$-vrijednost", "okvirna interpretsacija"))
```
...
```{r qq1a, fig.cap="", echo=FALSE, fig.height=3, fig.width=6}
  width <- 5
  height <- 5
...
```{r qq2b, fig.cap="", echo=FALSE, fig.height=4}
  plotTwo( skewed.data )
```
...
```{r qq2c, fig.cap="", echo=FALSE, fig.height=4}
