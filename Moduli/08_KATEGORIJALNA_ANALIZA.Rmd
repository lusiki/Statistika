...
- Pregled podataka (cards) za analizu
...
.hi[Tabulirani pregled *cards* podataka]
...
- Formiraj očekivane vjerojatnosti u R
...
```{r echo=FALSE}
knitr::kable(tibble::tribble(
               ~"NANA", ~"Before: Yes", ~"Before: No", ~"Ukupno",
  "After: Yes",           "5",          "5",    "10",
  "After: No",          "25",         "65",    "90",
  "Ukupno",          "30",         "70",    "100"
  ), col.names = c("", "Before: Yes", "Before: No", "Ukupno"), align = 'lccc')
```
