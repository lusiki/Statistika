...
```{r regression0, fig.cap="", echo=FALSE, fig.height=7}
...
```{r regression1a, fig.cap="", echo=FALSE, fig.height=7}
  # good regression ine
...
---
```{r regression1b, fig.cap="", echo=FALSE, fig.height=7}
...
```{r regression3a, fig.cap="", echo=FALSE, fig.height=7}
...
```{r regression3b, fig.cap="", echo=FALSE, fig.height=7}
